...
The code below shows how I created the model using the the fast.ai library. I created a dataset of 272 images from DuckDuckGo search and cleaned them manually. Then I used the dataset to fine-tune several image classification models. Throughout, I use ideas and code from the [fast.ai course](https://course.fast.ai/) and feedback from ChatGPT. The code can be reviewed and tested as a [Jupyter notebook](https://github.com/willhenrich/gun_detector/edit/main/README.md), and the cleaned data is available at in the "hands" directory [here](https://github.com/willhenrich/gun_detector/tree/main).
